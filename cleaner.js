...
async function start(id, pw) {
    ...
    var delete_button = "#container > article > div > div.wrap_right > section > div.gallog_cont.postings > div > ul > li:nth-child(1) > div > div > button"
    ...
    delete_button = "#container > article > div > div.wrap_right > section > div.gallog_cont.comments > div > ul > li:nth-child(1) > div > div > button"
